...
public class AccountGroupAdapter extends BaseAdapter {
    ...
    private ArrayList<AccountGroupPojo> arraylist;
    private Handler handler;

    private static Context context;
    public static AlertDialog alertDialog1;
    ArrayList<AccountGroupPojo> AccountGroupPojos;
    ConnectionDetector cd;
    String id;
    String clickedid;

    public AccountGroupAdapter(ArrayList<AccountGroupPojo> AccountGroupPojos, Context context) {

        this.AccountGroupPojos = AccountGroupPojos;
        this.arraylist = new ArrayList<AccountGroupPojo>();
        this.arraylist.addAll(AccountGroupPojos);
    ...
    @Override
    public int getCount() {
        return AccountGroupPojos.size();
    }

    @Override
    public Object getItem(int position) {
        return AccountGroupPojos.get(position);
    }

    @Override
    public long getItemId(int position) {
        return AccountGroupPojos.indexOf(AccountGroupPojos.get(position));
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final AccountGroupPojo accountGroupPojo = AccountGroupPojos.get(position);
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);

        if (convertView == null) {
            convertView = inflater.inflate(R.layout.listview_row_account_group, null);
            holder = new AccountGroupAdapter.ViewHolder();
...
//                    .findViewById(R.id.category);
            ...
            holder = (AccountGroupAdapter.ViewHolder) convertView.getTag();
        }
...
//        holder.mCategory.setText(attribute);
        ...
        holder.idimageviewedit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, UpdateAccountGroupActivity.class);
