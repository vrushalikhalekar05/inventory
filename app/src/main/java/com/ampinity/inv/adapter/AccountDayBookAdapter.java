...
import com.ampinity.inv.Model.AccountDayBookPojo;
...
public class AccountDayBookAdapter extends BaseAdapter {

    private ArrayList<AccountDayBookPojo> arraylist;
    private Handler handler;

    private static Context context;
    public static AlertDialog alertDialog1;
    ArrayList<AccountDayBookPojo> AccountDayBookPojos;
    ConnectionDetector cd;
    String id;
    String clickedid;

    public AccountDayBookAdapter(ArrayList<AccountDayBookPojo> AccountDayBookPojos, Context context) {

        this.AccountDayBookPojos = AccountDayBookPojos;
        this.arraylist = new ArrayList<AccountDayBookPojo>();
        this.arraylist.addAll(AccountDayBookPojos);
    ...
    @Override
    public int getCount() {
        return AccountDayBookPojos.size();
    }

    @Override
    public Object getItem(int position) {
        return AccountDayBookPojos.get(position);
    }

    @Override
    public long getItemId(int position) {
        return AccountDayBookPojos.indexOf(AccountDayBookPojos.get(position));
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final AccountDayBookPojo accountDayBookPojo = AccountDayBookPojos.get(position);
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);

        if (convertView == null) {
            convertView = inflater.inflate(R.layout.listview_row_account_ledger, null);
            holder = new AccountDayBookAdapter.ViewHolder();
...
//                    .findViewById(R.id.category);
            ...
            holder = (AccountDayBookAdapter.ViewHolder) convertView.getTag();
        }
