...
import com.ampinity.inv.Model.AccountBankBookPojo;
...
public class AccountBankBookAdapter extends BaseAdapter {

    private ArrayList<AccountBankBookPojo> arraylist;
    private Handler handler;

    private static Context context;
    public static AlertDialog alertDialog1;
    ArrayList<AccountBankBookPojo> AccountBankBookPojos;
    ConnectionDetector cd;
    String id;
    String clickedid;

    public AccountBankBookAdapter(ArrayList<AccountBankBookPojo> AccountBankBookPojos, Context context) {

        this.AccountBankBookPojos = AccountBankBookPojos;
        this.arraylist = new ArrayList<AccountBankBookPojo>();
        this.arraylist.addAll(AccountBankBookPojos);
    ...
    @Override
    public int getCount() {
        return AccountBankBookPojos.size();
    }

    @Override
    public Object getItem(int position) {
        return AccountBankBookPojos.get(position);
    }

    @Override
    public long getItemId(int position) {
        return AccountBankBookPojos.indexOf(AccountBankBookPojos.get(position));
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final AccountBankBookPojo accountBankBookPojo = AccountBankBookPojos.get(position);
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);

        if (convertView == null) {
            convertView = inflater.inflate(R.layout.listview_row_account_ledger, null);
            holder = new AccountBankBookAdapter.ViewHolder();
...
//                    .findViewById(R.id.category);
            ...
            holder = (AccountBankBookAdapter.ViewHolder) convertView.getTag();
        }
