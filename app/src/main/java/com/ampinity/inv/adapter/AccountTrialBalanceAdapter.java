...
import com.ampinity.inv.Model.AccountTrialBalancePojo;
...
public class AccountTrialBalanceAdapter extends BaseAdapter {

    private ArrayList<AccountTrialBalancePojo> arraylist;
    private Handler handler;

    private static Context context;
    public static AlertDialog alertDialog1;
    ArrayList<AccountTrialBalancePojo> AccountTrialBalancePojos;
    ConnectionDetector cd;
    String id;
    String clickedid;
    public AccountTrialBalanceAdapter(ArrayList<AccountTrialBalancePojo> AccountTrialBalancePojos, Context context) {
        this.AccountTrialBalancePojos = AccountTrialBalancePojos;
        this.arraylist = new ArrayList<AccountTrialBalancePojo>();
        this.arraylist.addAll(AccountTrialBalancePojos);
    ...
    @Override
    public int getCount() {
        return AccountTrialBalancePojos.size();
    }

    @Override
    public Object getItem(int position) {
        return AccountTrialBalancePojos.get(position);
    }

    @Override
    public long getItemId(int position) {
        return AccountTrialBalancePojos.indexOf(AccountTrialBalancePojos.get(position));
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final AccountTrialBalancePojo accountTrialBalancePojo = AccountTrialBalancePojos.get(position);
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);

        if (convertView == null) {
            convertView = inflater.inflate(R.layout.listview_row_account_ledger, null);
            holder = new AccountTrialBalanceAdapter.ViewHolder();
...
//                    .findViewById(R.id.category);
            ...
            holder = (AccountTrialBalanceAdapter.ViewHolder) convertView.getTag();
        }
