...
import com.ampinity.inv.Model.AccountLedgerBalancePojo;
...
public class AccountLedgerBalanceAdapter extends BaseAdapter {

    private ArrayList<AccountLedgerBalancePojo> arraylist;
    private Handler handler;

    private static Context context;
    public static AlertDialog alertDialog1;
    ArrayList<AccountLedgerBalancePojo> AccountLedgerBalancePojos;
    ConnectionDetector cd;
    String id;
    String clickedid;

    public AccountLedgerBalanceAdapter(ArrayList<AccountLedgerBalancePojo> AccountLedgerBalancePojos, Context context) {

        this.AccountLedgerBalancePojos = AccountLedgerBalancePojos;
        this.arraylist = new ArrayList<AccountLedgerBalancePojo>();
        this.arraylist.addAll(AccountLedgerBalancePojos);
    ...
    @Override
    public int getCount() {
        return AccountLedgerBalancePojos.size();
    }

    @Override
    public Object getItem(int position) {
        return AccountLedgerBalancePojos.get(position);
    }

    @Override
    public long getItemId(int position) {
        return AccountLedgerBalancePojos.indexOf(AccountLedgerBalancePojos.get(position));
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final AccountLedgerBalancePojo accountLedgerBalancePojo = AccountLedgerBalancePojos.get(position);
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);

        if (convertView == null) {
            convertView = inflater.inflate(R.layout.listview_row_account_ledger, null);
            holder = new AccountLedgerBalanceAdapter.ViewHolder();
...
//                    .findViewById(R.id.category);
            ...
            holder = (AccountLedgerBalanceAdapter.ViewHolder) convertView.getTag();
        }
