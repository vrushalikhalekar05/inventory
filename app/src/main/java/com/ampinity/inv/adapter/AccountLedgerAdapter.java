...
public class AccountLedgerAdapter extends BaseAdapter {
    ...
    private ArrayList<AccountLedgerPojo> arraylist;
    private Handler handler;

    private static Context context;
    public static AlertDialog alertDialog1;
    ArrayList<AccountLedgerPojo> AccountLedgerPojos;
    ConnectionDetector cd;
    String id;
    String clickedid;

    public AccountLedgerAdapter(ArrayList<AccountLedgerPojo> AccountLedgerPojos, Context context) {

        this.AccountLedgerPojos = AccountLedgerPojos;
        this.arraylist = new ArrayList<AccountLedgerPojo>();
        this.arraylist.addAll(AccountLedgerPojos);
    ...
    @Override
    public int getCount() {
        return AccountLedgerPojos.size();
    }

    @Override
    public Object getItem(int position) {
        return AccountLedgerPojos.get(position);
    }

    @Override
    public long getItemId(int position) {
        return AccountLedgerPojos.indexOf(AccountLedgerPojos.get(position));
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final AccountLedgerPojo accountLedgerPojo = AccountLedgerPojos.get(position);
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);

        if (convertView == null) {
            convertView = inflater.inflate(R.layout.listview_row_account_ledger, null);
            holder = new AccountLedgerAdapter.ViewHolder();
...
//                    .findViewById(R.id.category);
            ...
            holder = (AccountLedgerAdapter.ViewHolder) convertView.getTag();
        }
