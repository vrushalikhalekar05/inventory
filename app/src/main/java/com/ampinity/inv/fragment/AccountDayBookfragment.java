...
public class AccountDayBookfragment extends Fragment {
    Button idButtonExportExcelFile;


    public AccountDayBookfragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_account_daybook, container, false);
    }
    @Override
