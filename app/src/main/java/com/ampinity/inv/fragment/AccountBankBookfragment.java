...
public class AccountBankBookfragment extends Fragment {
    Button idButtonExportExcelFile;


    public AccountBankBookfragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_account_bankbook, container, false);
    }
    @Override
