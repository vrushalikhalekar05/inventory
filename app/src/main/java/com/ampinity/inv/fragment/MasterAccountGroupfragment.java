...
public class MasterAccountGroupfragment extends Fragment {
    Button idButtonAddAccountGroup;


    public MasterAccountGroupfragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_master_account_group, container, false);
    }
    @Override
    public void onViewCreated(View view, Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        idButtonAddAccountGroup=(Button)view.findViewById(R.id.idButtonAddAccountGroup);

        idButtonAddAccountGroup.setOnClickListener(new View.OnClickListener() {
            @Override
