...
import com.ampinity.inv.Activity.ActivityAddDateWise;
import com.ampinity.inv.Activity.AddDateWiseActivity;
...
import com.ampinity.inv.adapter.AdapterDateWiseDiscount;
 ...
 */
public class FragmentDateWiseDiscount extends Fragment {
    Button idButtonAddLob/*,idButtonExportLob*/;
    String sno;
    String Name1;
    int length;
    static AdapterDateWiseDiscount CompanyAdapte;
    private static final String SOAP_ACTION = "http://tempuri.org/GetData";
    private static final String METHOD_NAME = "GetData";
    private static final String NAMESPACE = "http://tempuri.org/";
    private ArrayList<DateWiseDiscont> productList;
    ...
    AdapterDateWiseDiscount adapterDateWiseDiscount;
    ArrayList<DateWiseDiscont> detailsOffer1ArrayList = new ArrayList<>();
    ListView lview;
    TableDataPojo tableDataPojo;
    int MY_PERMISSIONS_REQUEST_READ_CONTACTS;
    public FragmentDateWiseDiscount (){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_fragment_date_wise_discount, container, false);
    }
    @Override
    public void onViewCreated(View view, Bundle savedInstanceState) {

        super.onViewCreated(view, savedInstanceState);
        idButtonAddLob=(Button)view.findViewById(R.id.ButtonAddOffer);
        lview = (ListView) view.findViewById(R.id.listview);
        productList = new ArrayList<DateWiseDiscont>();
        //  listviewAdapter adapter = new listviewAdapter(getActivity(), productList);
        adapterDateWiseDiscount=new AdapterDateWiseDiscount(productList,getActivity());
        lview.setAdapter(adapterDateWiseDiscount);
        ...
        idButtonAddLob.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getActivity(), ActivityAddDateWise.class));
            }
        });
        populateList();
        adapterDateWiseDiscount.notifyDataSetChanged();
    ...
    public class myLobAsyncTask extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String  result) {
            ...
            try {
                ...
                FromDate=new String[length];
                ToDate=new String[length];
                TotalAttribute= new String[length];
                for (int i = 0; i < length; i++) {
                    JSONObject jsonObject = jsonArray.getJSONObject(i);
                    Id[i] = jsonObject.getString("id");
                    Name[i] = jsonObject.getString("OfferName");
                    Percentage[i]=jsonObject.getString("PercentageOffer");
                    FromDate[i]=jsonObject.getString("DateFrom");
                    ToDate[i]=jsonObject.getString("DateTo");
                    //  TotalAttribute[i] = jsonObject.getString("TotalAttribute");
                    Log.e("Name", "Name" + Name[i]);
                    Log.e("LobId", "LobId" + Id[i]);
                    Log.e("Percentage","Percentage"+Percentage[i]);
                    Log.e("FromDate","FromDate"+FromDate[i]);
                    Log.e("ToDate","ToDate"+ToDate[i]);

                    //   Log.e("TotalAttribute", "TotalAttribute" + TotalAttribute[i]);
                    // tableDataPojo = new TableDataPojo();

                    DateWiseDiscont dateWiseDiscont=new DateWiseDiscont();
                    dateWiseDiscont.setId(Id[i]);
                    dateWiseDiscont.setName(Name[i]);
                    dateWiseDiscont.setPertageOffer(Percentage[i]);
                    dateWiseDiscont.setFromDate(FromDate[i]);
                    dateWiseDiscont.setToDate(ToDate[i]);

                    //  tableDataPojo.setTotalAttribute(TotalAttribute[i]);

                    detailsOffer1ArrayList.add(dateWiseDiscont);
                    CompanyAdapte = new AdapterDateWiseDiscount(detailsOffer1ArrayList,getActivity());
    ...
    public class DeleteLobAsyncTask extends AsyncTask<Void, Void, Void>
    {
        ...
        protected Void doInBackground(Void... params) {
            String url =Config.Url+"DateiseDiscount.asmx";
