...
public class AccountProfitLossfragment extends Fragment {
    Button idButtonExportExcelFile;


    public AccountProfitLossfragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_account_profitloss, container, false);
    }
    @Override
