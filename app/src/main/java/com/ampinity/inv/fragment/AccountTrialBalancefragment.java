...
public class AccountTrialBalancefragment extends Fragment {
    Button idButtonExportExcelFile;


    public AccountTrialBalancefragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_account_trial_balance, container, false);
    }
    @Override
