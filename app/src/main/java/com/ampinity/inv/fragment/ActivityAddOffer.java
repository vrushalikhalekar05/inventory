...
public class ActivityAddOffer extends AppCompatActivity {
   ...
   // int lobid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Add Offer Details");
    ...
    public class getBankidAsyncTask extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(ActivityAddOffer.this);
...
//
    ...
    public class AddBankInsertDetailtAsyncTask extends AsyncTask<Void, Void, Void>
    {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            dialog.dismiss();
            finish();
            Toast.makeText(ActivityAddOffer.this,"Added Succesfully",Toast.LENGTH_SHORT).show();
        }
        @Override
