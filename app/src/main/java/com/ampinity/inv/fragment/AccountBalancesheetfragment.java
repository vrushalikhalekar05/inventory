...
public class AccountBalancesheetfragment extends Fragment {
    Button idButtonExportExcelFile;


    public AccountBalancesheetfragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_account_balance_sheet, container, false);
    }
    @Override
