...
public class AddCashPaymentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_cash_payment);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
       // getSupportActionBar().setDefaultDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Add Cash Payment Details");
        ...
        final ArrayAdapter<String> adapter2 = new CustomizedSpinnerAdapter(
                AddCashPaymentActivity.this, android.R.layout.simple_spinner_item,
                CompanyName);
        ...
        idEditTextDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(AddCashPaymentActivity.this, date, myCalendar
