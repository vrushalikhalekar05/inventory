...
public class UpdateRackMaster extends AppCompatActivity {
    Button idButtonCancel,idButtonSave;
    EditText idEditTextIDOffer,idEditTextId;
    String lobid;
    ConnectionDetector cd;
    String Id,RackMName,CompanyID;
    Bundle bundle;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_update_rack_master);
        ...
        RackMName = bundle.getString("RackName").toString();
        ...
        idEditTextIDOffer.setText(RackMName);
    ...
    public void validate(){
        ...
        if (idEditTextId.getText().toString().length()==0){
           ...
           RackMName=idEditTextIDOffer.getText().toString();
    ...
    public class AddLobtestAsyncTask extends AsyncTask<Void, Void, Void>
    {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(UpdateRackMaster.this);
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            dialog.dismiss();
            Toast.makeText(UpdateRackMaster.this,"Updated Succesfully",Toast.LENGTH_SHORT).show();
            finish();
        }
        @Override
        protected Void doInBackground(Void... params) {
            String urlupdate = Config.Url+"RackMaster.asmx";
...
//                requestupdatelob.addProperty(TotalAttributep);
                ...
                requestupdatelob.addProperty("RackName", RackMName);
