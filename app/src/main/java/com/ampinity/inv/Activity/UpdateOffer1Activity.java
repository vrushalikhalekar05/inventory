...
public class UpdateOffer1Activity extends AppCompatActivity {
    Button idButtonCancel,idButtonSave;
    EditText idEditTextIDOffer,idEditTextId;
    String lobid;
    ConnectionDetector cd;
    String Id,SchemeName,CompanyID;
    Bundle bundle;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_update_offer1);
    ...
    public class AddLobtestAsyncTask extends AsyncTask<Void, Void, Void>
    {
        ProgressDialog dialog;
            ...
            super.onPreExecute();
            dialog = new ProgressDialog(UpdateOffer1Activity.this);
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                dialog.dismiss();
                Toast.makeText(UpdateOffer1Activity.this,"Updated Succesfully",Toast.LENGTH_SHORT).show();
                finish();
        }
        @Override
        protected Void doInBackground(Void... params) {
                String urlupdate = Config.Url+"Offer1.asmx";
