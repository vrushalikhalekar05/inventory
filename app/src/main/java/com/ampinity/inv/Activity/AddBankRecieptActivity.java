...
public class AddBankRecieptActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_bank_reciept);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDefaultDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Add Bank Reciept Details");
        ...
        final ArrayAdapter<String> adapter2 = new CustomizedSpinnerAdapter(
                AddBankRecieptActivity.this, android.R.layout.simple_spinner_item,
                CompanyName);
        ...
        idEditTextDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(AddBankRecieptActivity.this, date, myCalendar
