...
public class UpdateDateWiseActivity extends AppCompatActivity {
    Button idButtonCancel,idButtonSave;
    EditText idEditTextIDOffer,idEditTextId;
    String lobid;
    ConnectionDetector cd;
    String Id,SchemeName,CompanyID,DateFrom,DateTo,PercenOffer;
    Bundle bundle;

    @Override
        protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_update_date_wise);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDefaultDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Update Offer1 Details");
        ...
        DateFrom=bundle.getString("FromDate").toString();
        DateTo=bundle.getString("ToDate").toString();
        PercenOffer=bundle.getString("PerOffer").toString();
    ...
    public class AddLobtestAsyncTask extends AsyncTask<Void, Void, Void>
    {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(UpdateDateWiseActivity.this);
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            dialog.dismiss();
            Toast.makeText(UpdateDateWiseActivity.this,"Updated Succesfully",Toast.LENGTH_SHORT).show();
            finish();
        }
        @Override
        protected Void doInBackground(Void... params) {
            String urlupdate = Config.Url+"DatewiseDiscount.asmx";
...
//                requestupdatelob.addProperty(TotalAttributep);
                ...
                requestupdatelob.addProperty("OfferName", SchemeName);
                requestupdatelob.addProperty("DateFrom",DateFrom);
                requestupdatelob.addProperty("DateTo",DateTo);
                requestupdatelob.addProperty("PercentageOffer",PercenOffer);
