...
public class UpdateVenderDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_vender_detail);


        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDefaultDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Update Vender Details");
        ...
        stridEditTextIDVenderDetail=bundle.getString("Id").toString();
        stridEditTextVenderName=bundle.getString("Name").toString();
        stridEditTextAddress=bundle.getString("Address").toString();
        stridEditTextEmail=bundle.getString("Email").toString();
        stridEditTextPhoneNo=bundle.getString("PhoneNo").toString();
        stridEditTextGSTINNo=bundle.getString("GSTINNumber").toString();
        selcetedspinnerCity=bundle.getString("City").toString();
        selcetedspinnergroupname=bundle.getString("GroupName").toString();
        selcetedspinnerState=bundle.getString("State").toString();

        idEditTextIDVenderDetail.setText(stridEditTextIDVenderDetail);
        idEditTextVenderName.setText(stridEditTextVenderName);
        idEditTextAddress.setText(stridEditTextAddress);
        idEditTextEmail.setText(stridEditTextEmail);
        idEditTextPhoneNo.setText(stridEditTextPhoneNo);
        idEditTextGSTINNo.setText(stridEditTextGSTINNo);
        ...
        spinnergroupname.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                ...
                if (selcetedspinnergroupname.equals("Select GroupName")) {
...
//                    spinnerlobname.setAdapter(adapter1);
        ...
        spinnerState.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                ...
                if (selcetedspinnerState.equals("Select State")) {
                    ...
                    final ArrayAdapter<String> adapter1 = new CustomizedSpinnerAdapter(
                            UpdateVenderDetailActivity.this, android.R.layout.simple_spinner_item,
                            City);
        ...
        spinnerCity.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                ...
                if (selcetedspinnerCity.equals("Select TaxName")) {
//                    Lobname=new String[1];
//                    Lobname[0]=
//
//                    final ArrayAdapter<String> adapter1 = new CustomizedSpinnerAdapter(
...
//        spinnergroupname.setAdapter(adapter1);
    ...
    public class getgroupnamespinnerdataAsyncTask extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(UpdateVenderDetailActivity.this);
...
//
                ...
                final ArrayAdapter<String> adapter1 = new CustomizedSpinnerAdapter(UpdateVenderDetailActivity.this, android.R.layout.simple_spinner_item,
                        GroupName);
                spinnergroupname.setAdapter(adapter1);

                if (selcetedspinnergroupname != null) {
                    int spinnerPosition = adapter1.getPosition(selcetedspinnergroupname);
                    spinnergroupname.setSelection(spinnerPosition);
                }
...
//
                ...
                if (selcetedspinnerState != null) {
                    int spinnerPosition = adapter1.getPosition(selcetedspinnerState);
...
//
                ...
                if (selcetedspinnerCity != null) {
                    int spinnerPosition = adapter1.getPosition(selcetedspinnerCity);
...
//                lobid=String.valueOf(result);
    ...
    public void validate()
    {
        ...
        if (idEditTextAddress.getText().toString().length()==0){
        ...
        else if (selcetedspinnergroupname.equals("Select City")){
            Toast.makeText(this,"Please Select State",Toast.LENGTH_SHORT).show();
        }
            ...
            new UpdateVenderDetailInsertDetailtAsyncTask().execute();
        }
    }

    public class UpdateVenderDetailInsertDetailtAsyncTask extends AsyncTask<Void, Void, Void>
    {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            dialog.dismiss();
            finish();
            Toast.makeText(UpdateVenderDetailActivity.this,"Updated Succesfully",Toast.LENGTH_SHORT).show();
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                requestAddlob.addProperty("ID",stridEditTextIDVenderDetail );
