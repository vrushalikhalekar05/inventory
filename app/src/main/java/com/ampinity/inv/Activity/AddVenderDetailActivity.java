...
public class AddVenderDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_vender_detail);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
      //  getSupportActionBar().setDefaultDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Add Vender Details");
...
//        spinnergroupname.setAdapter(adapter1);
    ...
    public class getgroupnamespinnerdataAsyncTask extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(AddVenderDetailActivity.this);
...
//
                ...
                final ArrayAdapter<String> adapter1 = new CustomizedSpinnerAdapter(AddVenderDetailActivity.this, android.R.layout.simple_spinner_item,
                        GroupName);
                spinnergroupname.setAdapter(adapter1);
...
//                Log.e("SOAPLOG", e.getMessage());
    ...
    public void validate()
    {
        ...
        else if (selcetedspinnergroupname.equals("Select GroupName")){
            Toast.makeText(this,"Please Select Groupname",Toast.LENGTH_SHORT).show();
        }
    ...
    public class AddVenderDetailInsertDetailtAsyncTask extends AsyncTask<Void, Void, Void>
    {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            dialog.dismiss();
            finish();
            Toast.makeText(AddVenderDetailActivity.this,"Added Succesfully",Toast.LENGTH_SHORT).show();
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                requestAddlob.addProperty("Id_C","1");
                requestAddlob.addProperty("CompanyID","2");
...
//                dialog.dismiss();
    ...
    public class getidAsyncTask extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String aVoid) {
            ...
            Toast.makeText(AddVenderDetailActivity.this, "ID"+aVoid, Toast.LENGTH_SHORT).show();
            try {
                JSONArray jsonArray = new JSONArray(String.valueOf(aVoid));
