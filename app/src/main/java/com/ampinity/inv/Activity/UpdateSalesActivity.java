...
public class UpdateSalesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Update Sales");
        ...
        final ArrayAdapter<String> adapter2 = new CustomizedSpinnerAdapter(
                UpdateSalesActivity.this, android.R.layout.simple_spinner_item,
                CompanyName);
        ...
        idEditTextDatePaid.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(UpdateSalesActivity.this, date, myCalendar
...
//            items.add(tablepojo);
        ...
        tableDataAdapter = new TableDataAdapter(items, UpdateSalesActivity.this);
