...
public class AddAccountLedgerActivity extends AppCompatActivity {

    Spinner spinneraccountname,spinneraccountgroupname,spinneropeningbalance,spinnerclosingbalance;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_account_ledger);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDefaultDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Add Account Ledger Details");
        ...
        spinneropeningbalance = (Spinner) findViewById(R.id.spinneropeningbalance);
        spinnerclosingbalance = (Spinner) findViewById(R.id.spinnerclosingbalance);
        final ArrayAdapter<String> adapter1 = new CustomizedSpinnerAdapter(
                AddAccountLedgerActivity.this, android.R.layout.simple_spinner_item,
                CompanyName);
        spinneraccountname.setAdapter(adapter1);
        final ArrayAdapter<String> adapter2 = new CustomizedSpinnerAdapter(
                AddAccountLedgerActivity.this, android.R.layout.simple_spinner_item,
                CompanyName);
        spinneraccountgroupname.setAdapter(adapter2);
        /*spinneropeningbalance.setAdapter(adapter2);
        spinnerclosingbalance.setAdapter(adapter2);*/
    ...
    public class getAccountLedgeridAsyncTask extends AsyncTask<String, Integer, String> {
        ProgressDialog dialog;
        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(AddAccountLedgerActivity.this);
